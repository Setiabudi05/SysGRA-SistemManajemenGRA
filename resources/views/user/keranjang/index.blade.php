                                ...
                                <div class="p-4 mb-3 border rounded-4 bg-white shadow-xs">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-5 text-md-end mt-3 mt-md-0">
                                            <div class="mb-2"><small class="text-muted d-block">Harga Paket (Flat):</small>
                                                <span class="fw-bold text-dark">Rp {{ number_format((int) $cart->paket->harga, 0, ',', '.') }}</span>
                                            </div>
                                            <div class="mb-2"><small class="text-muted d-block">Harga Tambahan (Flat):</small>
                                                <span class="fw-bold text-info">Rp {{ number_format($cart->addOns->sum('harga'), 0, ',', '.') }}</span>
                                            </div>
                                            <div class="border-top pt-2 mt-2"><small class="text-muted d-block">Subtotal:</small>
                                            ...
                                            <form id="delete-form-{{ $cart->id }}" action="{{ route('user.keranjang.destroy', $cart->id) }}" method="POST" class="d-none">@csrf @method('DELETE')</form>
                                        </div>
                                    </div>
                                </div>
