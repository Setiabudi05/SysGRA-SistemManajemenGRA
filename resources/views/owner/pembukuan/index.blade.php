...
@push('css')
    ...
    <style>
        .stats-icon { width: 3rem; height: 3rem; border-radius: 0.5rem; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; color: #fff; }
        .green { background-color: #435ebe; }
        .red { background-color: #ff7976; }
        .blue { background-color: #57caeb; }
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 d-flex justify-content-md-end align-items-center gap-2 mt-3 mt-md-0">
                    <form action="{{ route('owner.pembukuan.index') }}" method="GET" class="d-flex gap-2">
                        <input type="date" name="start_date" class="form-control form-control-sm shadow-sm" value="{{ $start }}">
                        <input type="date" name="end_date" class="form-control form-control-sm shadow-sm" value="{{ $end }}">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card border-start border-success border-4 shadow-sm">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            <div class="col-md-4 d-flex justify-content-start"><div class="stats-icon green mb-2"><i class="bi bi-graph-up"></i></div></div>
                            <div class="col-md-8">
            ...
            <div class="col-md-4">
                <div class="card border-start border-danger border-4 shadow-sm">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            <div class="col-md-4 d-flex justify-content-start"><div class="stats-icon red mb-2"><i class="bi bi-graph-down"></i></div></div>
                            <div class="col-md-8">
            ...
            <div class="col-md-4">
                <div class="card border-start border-primary border-4 shadow-sm">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            <div class="col-md-4 d-flex justify-content-start"><div class="stats-icon blue mb-2"><i class="bi bi-wallet2"></i></div></div>
                            <div class="col-md-8">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-transparent border-0 pb-0"><h6 class="fw-bold text-success"><i class="bi bi-arrow-down-left-circle me-2"></i>Pemasukan</h6></div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover small w-100" id="table-pemasukan">
                                <thead><tr><th>No</th><th>Customer</th><th>Nominal</th></tr></thead>
                                <tbody>
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-transparent border-0 pb-0"><h6 class="fw-bold text-danger"><i class="bi bi-arrow-up-right-circle me-2"></i>Pengeluaran</h6></div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover small w-100" id="table-pengeluaran">
                                <thead><tr><th>No</th><th>Keterangan</th><th>Nominal</th></tr></thead>
                                <tbody>
                                    @foreach($listPengeluaran as $item)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $item->keterangan ?? '-' }}</td>
                                        <td class="fw-bold text-danger">Rp {{ number_format($item->nominal, 0, ',', '.') }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
