    ...
    $(document).ready(function() {
        let table = $('#table-pembayaran').DataTable({
            ...
            columns: [
                ...
                { data: 'paket_nama', name: 'paket_nama', defaultContent: '-' },
                { 
                    data: 'harga_paket', 
                ...
                { data: 'sisa_tagihan', name: 'sisa_tagihan', orderable: false },
                { data: 'status_pembayaran', name: 'status_pembayaran', class: 'text-center', orderable: false },
