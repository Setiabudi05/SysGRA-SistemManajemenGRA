                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group gap-1">
                                        <a href="{{ route('admin.pembayaran.nota', $p->id) }}" target="_blank" class="btn btn-sm btn-outline-primary shadow-sm" title="Cetak Nota">
                                            <i class="bi bi-printer"></i>
                                        </a>
                                        <button type="button" onclick="hapusPembayaran('{{ $p->id }}')" class="btn btn-sm btn-outline-danger shadow-sm">
