...
<div class="page-heading">
    <div class="page-title">
        <div class="row align-items-center">
            ...
            {{-- Navigasi Teks Halus di Pojok Kanan Atas --}}
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" action="{{ route('admin.pembayaran.store') }}" method="POST" data-parsley-validate>
                            ...
                            {{-- PENGAMAN: Menampilkan pesan eror validasi jika ada ketidaksesuaian data --}}
                            @if ($errors->any())
                                <div class="alert alert-danger alert-dismissible show fade mb-4">
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-exclamation-triangle-fill me-2 fs-5"></i>
                                        <h6 class="alert-heading fw-bold mb-0">Gagal Menyimpan Transaksi:</h6>
                                    </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 mb-4">
                                    ...
                                    {{-- PERBAIKAN UTAMA: Name diubah menjadi pesanan_id agar sinkron dengan Controller --}}
                                    <select name="pesanan_id" class="form-select shadow-sm @error('pesanan_id') is-invalid @enderror" required>
                                        <option value="">-- Pilih Nama Pengantin --</option>
                                        @foreach($list_booking as $b)
                                            <option value="{{ $b->id }}" {{ old('pesanan_id') == $b->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group shadow-sm">
                                        ...
                                        <input type="text" name="jumlah_bayar" id="jumlah_bayar"
                                            ...
                                            placeholder="0" value="{{ old('jumlah_bayar') }}" required>
                                    </div>
                                    @error('jumlah_bayar')
...
<script>
    $(document).ready(function() {
        // Format Rupiah Otomatis saat admin mengetik nominal cicilan
