                        ...
                        <div class="row mt-2">
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    <label for="jadwal_pengantin_id" class="fw-bold">Pilih Tanggal Jadwal <span class="mandatory text-danger">*</span></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="tahun" class="form-control shadow-sm" readonly placeholder="Otomatis">
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea id="alamat" class="form-control shadow-sm" rows="2" readonly placeholder="Otomatis"></textarea>
                                </div>
                            </div>

                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    <label for="gown" class="fw-bold">Nama Gown / Rincian <span class="mandatory text-danger">*</span></label>
                                    <textarea name="gown" id="gown" class="form-control shadow-sm" rows="3" placeholder="Masukkan detail gown yang digunakan..." required>{{ old('gown') }}</textarea>
                                </div>
                            </div>
                        </div>
