        ...
        let table = $('.bookings-table').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    name: 'package_price',
                    render: function(data) {
                        let val = data ? parseInt(data.toString().replace(/[^0-9]/g, '')) : 0;
                        let formatted = val.toLocaleString('id-ID');
                        return `
                                <div class="price-align text-dark">
                                    <span>Rp</span>
                                    <span>${formatted}</span>
                                </div>`;
                    }
                },
                {
                    ...
                    render: function(data) {
                        ...
                        return `
                                <div class="price-align ${colorClass}">
                                    <span>Rp</span>
                                    <span>${formatted}</span>
                                </div>`;
                    }
